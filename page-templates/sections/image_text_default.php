...
<section class="image-text">
    <div class="container">
        <div class="row">
            <div
                class="col-12 col-lg-5 order-1 <?php echo $image_position === "right" ? "order-lg-0" : "order-lg-2 offset-lg-1 " ?>">
            ...
            <div class="col-12 col-lg-6 order-lg-1 <?php echo $image_position === "right" ? "offset-lg-1" : "" ?>">
