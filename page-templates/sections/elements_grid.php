                        ...
                        <div class="elements-grid__element">
                            <?php if ($image): ?>
                                <img src="<?php echo $image['url'] ?>" alt="<?php echo $image['alt'] ?>"
                                    class="elements-grid__element-image">
                            <?php endif; ?>
                    ...
                    <div class="elements-grid__controls">
                        ...
                        <div class="elements-grid__slider-arrows">
                            <button class="elements-grid__slider-arrow" aria-label="Slider left" data-glide-dir="<">
                                <img src="<?php echo get_theme_icon_url('arrow-right-solid.svg') ?>" alt=""
                                    class="elements-grid__slider-arrow-img elements-grid__slider-arrow-img--prev">
                            </button>
                            <button class="elements-grid__slider-arrow" aria-label="Slider right" data-glide-dir=">">
                                <img src="<?php echo get_theme_icon_url('arrow-right-solid.svg') ?>" alt=""
                                    class="elements-grid__slider-arrow-img elements-grid__slider-arrow-img--next">
                            </button>
                        </div>
                    </div>
                </div>
