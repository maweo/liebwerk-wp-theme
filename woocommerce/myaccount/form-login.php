        ...
        <div class="row mb-5 liebwerk-account__login-register-container">
            ...
            <div class="col-lg-6">
                ...
                <form method="post">
                    ...
                    <p class="text-muted">
                        <?php _e('*Required field', 'maweo'); ?>
                    </p>

                    <div class="form-group my-4">
                        <label class="mb-2" for="username">
                            <strong>
                                <?php _e('E-Mail Address', 'maweo'); ?>&nbsp;<span class="required">*</span>
                            </strong>
                        </label>
                    ...
                    <p class="woocommerce-LostPassword lost_password">
                        <a
                            href="<?php echo esc_url(wp_lostpassword_url()); ?>"><?php _e('Forgot my password', 'maweo'); ?></a>
                    </p>
                    ...
                    <label
                        ...
                        <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme"
                            ...
                            <?php _e('Keep me logged in', 'maweo'); ?>
                        </span>
                    </label>
            ...
            <div class="col-lg-6">
                <div class="liebwerk-account__login-register-col">
                    <p class="text-muted mb-3">
                        <?php _e('First time here?', 'maweo'); ?>
                    </p>
                    <h2 class="mb-0">
                        <?php esc_html_e('Create an Account', 'maweo'); ?>
                    </h2>
                    <p class="text-muted">
                        <?php esc_html_e('*Required field', 'maweo'); ?>
                    </p>
                    ...
                    <form method="post" class="" <?php do_action('woocommerce_register_form_tag'); ?>>
                        ...
                        <p class="woocommerce-form-row form-row">
                            ...
                            <button type="submit"
                                class="liebwerk-account__login-register-button liebwerk-account__login-register-button--register mt-3"
